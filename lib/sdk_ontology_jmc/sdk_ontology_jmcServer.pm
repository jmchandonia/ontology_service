package sdk_ontology_jmc::sdk_ontology_jmcServer;
...
our %method_authentication = (
        ...
        'list_public_ontologies' => 'required',
        'list_ontologies' => 'required',
...
sub call_method {
    ...
    my $ctx = sdk_ontology_jmc::sdk_ontology_jmcServerContext->new($self->{loggers}->{userlog},
...
{
    # Service sdk_ontology_jmc requires authentication.
	...
	{
	    $self->exception('PerlError', "Authentication required for sdk_ontology_jmc but no authentication header was passed");
	}
    ...
    my @result;
    {
        ...
        my $stderr = sdk_ontology_jmc::sdk_ontology_jmcServerStderrWrapper->new($ctx, $get_time);
        $ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service sdk_ontology_jmc.");
    }
...
package sdk_ontology_jmc::sdk_ontology_jmcServerContext;

use strict;

=head1 NAME

sdk_ontology_jmc::sdk_ontology_jmcServerContext
...
package sdk_ontology_jmc::sdk_ontology_jmcServerStderrWrapper;
...
unless (caller) {
    ...
    my $server = sdk_ontology_jmc::sdk_ontology_jmcServer->new(
